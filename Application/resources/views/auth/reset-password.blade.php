...
<body>
    <div class="login-card mb-5 p-5 position-absolute top-50 start-50 translate-middle">
        ...
        <form class="recsenha" method="post" action="{{ route('password.update') }}" enctype="multipart/form" id="login">
            @csrf
            ...
            <div class="form-group">
                ...
                <input required="" name="password" id="password" type="password" placeholder="Isira sua nova senha" maxlength="50">
            </div>

            <div class="form-group">
                <label for="password_confirmation">Confirme:</label>
                <input required="" name="password_confirmation" id="password" type="password" placeholder="Confirme sua nova senha" maxlength="50">
            </div>
