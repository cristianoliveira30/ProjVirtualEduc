...
<body>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <form class="d-flex position-absolute top-40 start-50">
      ...
      <div>
        <a class="btn btn-primary" href="#" role="button">Cadastre-se</a>        
    ...
    <main>
      <h1 class="position-absolute top-50 start-50 translate-middle">Título</h1>
    </main>
    <footer>
